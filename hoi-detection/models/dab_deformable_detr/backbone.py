...
class BackboneBase(nn.Module):
    def __init__(
        ...
        elif "wave" in backbone_name:
            if pretrained != "":
                backbone.load_checkpoint(pretrained)
            self.strides = [8, 16, 32]
            self.body = backbone
            self.num_channels = [64, 512, 512]
            if "large" in backbone_name:
                self.num_channels = [144, 1152, 1152]
        else:
    ...
    def __init__(
        ...
        if "swin" in backbone_name:
            ...
            if "tiny" in backbone_name:
                backbone = build_wave(in_channel=3, has_ray=has_ray)
            else:
            ...
            assert backbone_name not in ("resnet18", "resnet34"), (
